                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <form action="{{ route('subcategory.update',$subcategory->id) }}" method="POST" class="tm-edit-product-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="subcategory_en" type="text"  value="{{ $subcategory->subcategory_en }}"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="stock" name="subcategory_bn" type="text" value="{{ $subcategory->subcategory_bn }}"
                        ...
                        <div class="input-group mb-3">
                            ...
                            @error('category') is-invalid @enderror"
                                ...
                                @foreach ($categories as $c)
                                    <option value="{{ $c->id }}"
                                    <?php if($c->id == $subcategory->category_id) echo"selected"?>>{{ $c->category_en }} | {{ $c->category_bn }}
                                    </option>
                                @endforeach
                            </select>
                            @error('category')
