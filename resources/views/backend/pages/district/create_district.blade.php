...
@section('content')
    <div class="col-xl-12 col-lg-10 col-md-12 col-sm-12">
        <div class="bg-white tm-block">
            <div class="row">
                <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">Add District </h2>
                </div>
            </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <form action="{{ route('district.store') }}" method="POST" class="tm-edit-product-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="district_en" type="text"
                                class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7 @error('district_en') is-invalid @enderror">
                            @error('district_en')
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="stock" name="district_bn" type="text"
                                class="form-control validate col-xl-12 col-lg-12 col-md-7 col-sm-7 @error('district_bn') is-invalid @enderror"><br>
                            @error('district_bn')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
