                    ...
                    <form action="{{ route('category.store') }}" method="POST" class="tm-edit-product-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="category_en" type="text"
                                class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7 @error('category_en') is-invalid @enderror/">
                            @error('category_en')
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="stock" name="category_bn" type="text"
                                class="form-control validate col-xl-12 col-lg-12 col-md-7 col-sm-7 @error('category_bn') is-invalid @enderror"><br>
                            @error('category_bn')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
